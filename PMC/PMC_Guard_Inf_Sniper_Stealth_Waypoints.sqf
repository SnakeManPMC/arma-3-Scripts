/*
	Create guard sniper stealth waypoints

Syntax:
[group, targetpoint, waypoint_radius] execVM "PMC\PMC_Guard_Inf_Sniper_Stealth_Waypoints.sqf";
...
PMC_Guard_Inf_Sniper_Stealth_Waypoints =
{
	private
	[
		"_grp",
